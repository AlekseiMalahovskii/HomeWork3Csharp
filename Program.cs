...
/*
bool IsPаlindromeFive(int number)
{
    // int n1 = number / 10000;
    // int n2 = number / 10 % 10;
    ...
    return number / 10000 == number % 10 && number / 10 % 10 == number / 1000 % 10;
}
...
{
    Console.WriteLine(IsPаlindromeFive(number));
}
*/
